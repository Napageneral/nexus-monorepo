# Apple Maps Adapter Package Install Validation

## Goal

Prove that the Apple Maps adapter is a real installable Nex adapter package and
...
- `dist/nexus-adapter-apple-maps-0.1.0.tar.gz` built successfully
