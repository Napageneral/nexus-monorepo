# CallRail Adapter Documentation

This package follows the canonical Nexus spec-driven workflow:

- `specs/` contains the active target-state adapter specs
- `workplans/` and `validation/` are used when the package has active
  package-local implementation or verification work
- `archive/` contains completed slices that are no longer active
...
- [CALLRAIL_ADAPTER_PACKAGE_INSTALL_WORKPLAN.md](/Users/tyler/nexus/home/projects/nexus/adapters/nexus-adapter-callrail/docs/archive/workplans/CALLRAIL_ADAPTER_PACKAGE_INSTALL_WORKPLAN.md)
- [CALLRAIL_ADAPTER_PACKAGE_INSTALL_VALIDATION.md](/Users/tyler/nexus/home/projects/nexus/adapters/nexus-adapter-callrail/docs/archive/validation/CALLRAIL_ADAPTER_PACKAGE_INSTALL_VALIDATION.md)

Live credential validation for first-clinic readiness is now tracked centrally
in:
