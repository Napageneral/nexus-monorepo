...
export type components = {
    schemas: {
        ...
        AdapterInfoSchema: {
            ...
            name: string;
            operations: ("adapter.info" | "adapter.health" | "adapter.accounts.list" | "adapter.monitor.start" | "adapter.control.start" | "adapter.setup.start" | "adapter.setup.submit" | "adapter.setup.status" | "adapter.setup.cancel" | "records.backfill" | "channels.send" | "channels.stream" | "channels.react" | "channels.edit" | "channels.delete")[];
            platform: string;
