# nexus-adapter-whatsapp SDK (TypeScript)

Generated consumer SDK for the published adapter package contract in `contracts/adapters/nexus-adapter-whatsapp/openapi.yaml`.
...
```ts
import { createWhatsAppAdapterClient } from "@nexus-project/nexus-adapter-whatsapp-sdk-ts";
