# Meta Ads Adapter Package Install Validation

## Goal

Prove that the Meta Ads adapter is a real installable Nex adapter package and
...
- `dist/nexus-adapter-meta-ads-0.1.0.tar.gz` built successfully
