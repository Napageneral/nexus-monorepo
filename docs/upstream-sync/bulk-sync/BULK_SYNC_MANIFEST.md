...
**Comparison:** `bulk-sync-ref` → `upstream/main`  
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/config/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/infra/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/agents/ ':!src/agents/tools/'
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/agents/tools/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/auto-reply/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/commands/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/cli/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/gateway/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/browser/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- src/channels/
```
...
**Files:** ~72 changed  
**Risk:** LOW  
**Diff:** `git diff bulk-sync-ref..upstream/main -- src/telegram/`

#### CHUNK-11: Discord
**Path:** `src/discord/`  
**Files:** ~54 changed  
**Risk:** LOW  
**Diff:** `git diff bulk-sync-ref..upstream/main -- src/discord/`

#### CHUNK-12: Slack
**Path:** `src/slack/`  
**Files:** ~53 changed  
**Risk:** LOW  
**Diff:** `git diff bulk-sync-ref..upstream/main -- src/slack/`

#### CHUNK-13: Signal & iMessage
**Paths:** `src/signal/`, `src/imessage/`  
**Files:** ~32 changed  
**Risk:** LOW  
**Diff:** `git diff bulk-sync-ref..upstream/main -- src/signal/ src/imessage/`
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- ui/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- apps/macos/
```
...
**Files:** ~200+ changed  
**Risk:** MEDIUM  
**Diff:** `git diff bulk-sync-ref..upstream/main -- apps/ios/`

#### CHUNK-17: Android App
**Path:** `apps/android/`  
**Files:** ~200+ changed  
**Risk:** MEDIUM  
**Diff:** `git diff bulk-sync-ref..upstream/main -- apps/android/`
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- docs/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- skills/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- scripts/ .github/
```
...
**Diff command:**
```bash
git diff bulk-sync-ref..upstream/main -- package.json tsconfig.json vitest.config.ts biome.json
```
