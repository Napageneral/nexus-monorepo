...
**Your task:**
1. Run: `git diff HEAD..upstream/main -- src/config/`
...
**Your task:**
1. Run: `git diff HEAD..upstream/main -- src/agents/ ':!src/agents/tools/'`
...
**Your task:**
1. Run: `git diff HEAD..upstream/main -- src/auto-reply/`
