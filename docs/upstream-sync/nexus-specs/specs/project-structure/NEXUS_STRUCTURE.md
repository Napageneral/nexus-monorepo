...
**Purpose:** Define ideal project structure given our three-ledger architecture
...
| `packages/opencode/src/permission/` | `packages/core/src/event-handler/acl/` | Policy-based, not per-call |
...
| `index/` | Derived layer | ✓ (was mnemonic) |
...
### Phase 5: Wire Index
1. Bring mnemonic/aix into nexus
2. Wire Index to read from all three ledgers
3. Wire Broker to query Index
