...
This matrix is now considered complete enough for board purposes.

Its main outcomes have already been absorbed into:

- the shared adapter work under `AIL-003`
- the website input work under `AIL-004`
- the backend outcome work under `AIL-005`

Future parity deltas should be recorded in the adapter and website package
specs directly rather than reopening this ticket as a standalone workstream.
