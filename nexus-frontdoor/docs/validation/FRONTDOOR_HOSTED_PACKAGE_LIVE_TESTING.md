...
- [frontdoor-package-lifecycle-smoke.mjs](/Users/tyler/nexus/home/projects/nexus/nexus-frontdoor/scripts/frontdoor-package-lifecycle-smoke.mjs)
...
Use this exact flow for `nexus-adapter-confluence`:

1. publish `nexus-adapter-confluence@<version>` in Frontdoor registry
2. create or use a Frontdoor API token for the target account
3. install or upgrade `nexus-adapter-confluence` onto the selected server
...
FRONTDOOR_SMOKE_ADAPTER_ID='nexus-adapter-confluence' \
...
- Frontdoor public adapter install behavior:
  [FRONTDOOR_SERVER_ADAPTER_INSTALL_VALIDATION.md](/Users/tyler/nexus/home/projects/nexus/nexus-frontdoor/docs/validation/FRONTDOOR_SERVER_ADAPTER_INSTALL_VALIDATION.md)
