...
It is the frontdoor control-plane projection of the shared hosted platform contract. It covers what frontdoor owns for:
...
Used for headless frontdoor-managed APIs and MCP-style control-plane access.
