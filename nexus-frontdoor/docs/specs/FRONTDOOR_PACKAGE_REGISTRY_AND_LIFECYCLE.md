...
3. resolves all required adapter and shared-service releases
4. writes desired server package state
5. stages the needed tarballs on the target server
6. invokes runtime operator install endpoints in dependency order
