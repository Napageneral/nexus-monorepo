...
>
> This file mixes proxy-mode deployment residue and session-based callback
> routing with target-state ideas. It is kept only as historical context.
>
...
>
> Written 2026-03-04. Companion to the archived Spike roadmap and the archived
> Spike nex app spec.
