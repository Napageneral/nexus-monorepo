...
import { createGtmWebsiteInputMapper, mapGtmDataLayerEvent } from "./index.mjs";

test("gtm mapper normalizes common event names into canonical website events", () => {
...
test("gtm mapper respects explicit overrides and batch mapping", () => {
  const mapper = createGtmWebsiteInputMapper({
    eventMap: {
