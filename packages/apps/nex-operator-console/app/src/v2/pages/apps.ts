  ...
  return html`
    <div class="v2-platform-picker">
      ...
      <p class="v2-platform-picker-footer">
        Don't see yours? <a href="#" class="v2-gold-text">Browse all integrations &rarr;</a>
      </p>
    </div>
  `;
}
  ...
  return html`
    <div class="v2-page-header">
      <div class="v2-page-header-row">
        <div>
          <h1 class="v2-page-title">Connected Apps</h1>
          <p class="v2-page-subtitle">Your apps power your AI agents. Connect platforms here, then use them via the CLI or API.</p>
        </div>
