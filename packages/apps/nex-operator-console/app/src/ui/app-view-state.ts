...
export type AppViewState = {
  ...
  // UI state for redesigned tab shells
  identitySubTab: IdentitySubTab;
  operationsSubTab: OperationsSubTab;
  systemSubTab: SystemSubTab;
  adaptersSubTab: AdaptersSubTab;
  ...
  handleRuntimeUrlConfirm: () => void;
  handleRuntimeUrlCancel: () => void;
  ...
  handleScheduleToggle: (jobId: string, enabled: boolean) => Promise<void>;
  handleScheduleRun: (jobId: string) => Promise<void>;
  handleScheduleRemove: (jobId: string) => Promise<void>;
  handleScheduleAdd: () => Promise<void>;
  handleScheduleRunsLoad: (jobId: string) => Promise<void>;
  handleScheduleFormUpdate: (path: string, value: unknown) => void;
