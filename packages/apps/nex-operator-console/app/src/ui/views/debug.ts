  ...
  return html`
    <section class="grid grid-cols-2">
            ...
            ${
              securitySummary
                ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  ...
                  <span class="mono">nexus security audit --deep</span> for details.
                </div>`
                : nothing
            }
      ...
      <div class="card">
        ...
        <div class="card-sub">Send a raw runtime method with JSON params.</div>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="card-sub">Latest runtime events.</div>
      ${
