...
import { formatDurationCompact } from "../../shared/format-duration.ts";
    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `nexus-usage-sessions-${exportStamp}.csv`,
                ...
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `nexus-usage-daily-${exportStamp}.csv`,
      ...
      <div style="margin-top: 12px;">
          ...
          <input
            ...
            placeholder="Filter sessions (e.g. key:agent:main:schedule* model:gpt-4o has:errors minTokens:2000)"
