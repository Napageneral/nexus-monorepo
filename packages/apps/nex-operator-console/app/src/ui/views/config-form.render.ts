...
export const SECTION_META: Record<string, { label: string; description: string }> = {
  env: {
    ...
    description: "Environment variables passed to the runtime process",
  },
  ...
  runtime: { label: "Runtime", description: "Runtime server settings (port, auth, binding)" },
  wizard: { label: "Setup Wizard", description: "Setup wizard state and history" },
  // Additional sections
  meta: { label: "Metadata", description: "Runtime metadata and version information" },
  ...
  schedule: { label: "Schedule", description: "Scheduled tasks and automation" },
