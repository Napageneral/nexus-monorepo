...
import { ClaudeAI, CursorIcon, Gemini, OpenAI, type Icon } from "../Icons";
import { cn } from "~/lib/utils";

export type ProviderKind = "codex" | "claudeAgent" | "cursor";

export type ServerProvider = {
  provider: ProviderKind;
  status: "ready" | "disabled" | "error" | "unavailable";
  enabled?: boolean;
  installed?: boolean;
  message?: string | null;
};

const PROVIDER_OPTIONS: Array<{ value: ProviderKind; label: string; available: boolean }> = [
...
export const ProviderModelPicker = memo(function ProviderModelPicker(props: {
  ...
  const handleModelChange = (provider: ProviderKind, value: string) => {
    ...
    const resolvedModel =
      props.modelOptionsByProvider[provider]?.find((option) => option.slug === value)?.slug ?? value;
