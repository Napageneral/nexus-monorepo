# Shopify Adapter Package Install Validation

## Goal

Prove that the Shopify adapter is a real installable Nex adapter package and
...
- `dist/shopify-0.1.0.tar.gz` built successfully
