...
`scripts/register-source-connection.sh` then creates the reviewed `moonsleep-production` connection with automatic work activation explicitly disabled and writes private custom-flow receipts.
