...
func parseGitMethodTarget(targetRef gitMethodTarget, methodName string) (deliveryTarget, error) {
	...
	switch methodName {
	case "bitbucket.repositories.list":
		return deliveryTarget{}, fmt.Errorf("%s does not accept payload.target", methodName)
	case "bitbucket.pull_requests.create", "bitbucket.branches.create", "bitbucket.branches.list", "bitbucket.commits.list", "bitbucket.pull_requests.list":
		if prID != "" {
	...
	case "bitbucket.pull_requests.comments.create", "bitbucket.pull_requests.merge", "bitbucket.pull_requests.comments.list":
		if prID == "" {
...
func executeGitMethod(ctx context.Context, req nexadapter.AdapterMethodRequest, methodName string) (*gitMethodResult, error) {
	...
	switch methodName {
	case "bitbucket.pull_requests.create":
	...
	case "bitbucket.pull_requests.comments.create":
	...
	case "bitbucket.pull_requests.merge":
	...
	case "bitbucket.branches.create":
