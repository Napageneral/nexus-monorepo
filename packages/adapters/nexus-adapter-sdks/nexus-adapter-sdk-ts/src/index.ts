...
export {
  ...
  AdapterProjectionFamilySchema,
  AdapterProjectionNormalizationSchema,
  AdapterProjectionRecordIdsSchema,
  AdapterProjectionRoutingSchema,
  AdapterProjectionSchema,
  AdapterProjectionSyncSchema,
...
export type {
  ...
  AdapterProjection,
  AdapterProjectionFamily,
  AdapterProjectionNormalization,
  AdapterProjectionRecordIds,
  AdapterProjectionRouting,
  AdapterProjectionSync,
