...
export function buildShopifyCheckoutAttributes(input = {}, options = {}) {
  ...
  const payload = cleanObject({
    web_installation_id: optionalText(source.web_installation_id ?? source.webInstallationId),
...
export function parseShopifyCheckoutAttributes(attributes = {}, options = {}) {
  ...
  return cleanObject({
    web_installation_id: read("web_installation_id"),
