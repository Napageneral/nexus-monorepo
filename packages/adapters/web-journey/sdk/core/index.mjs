...
const DEFAULT_BROWSER_STORAGE_KEY = "web-journey.browser_id";
const DEFAULT_SESSION_STORAGE_KEY = "web-journey.session_id";
const DEFAULT_SESSION_STARTED_STORAGE_KEY = "web-journey.session_started_at";
const DEFAULT_SESSION_ACTIVITY_STORAGE_KEY = "web-journey.session_last_activity_at";

export const WEB_JOURNEY_CONSENT_STATES = Object.freeze({
  granted: "granted",
  denied: "denied",
  unknown: "unknown",
});

export const WEB_JOURNEY_EVENT_NAMES = Object.freeze({
  page_view: "page_view",
...
export function createWebJourneyCore(options) {
