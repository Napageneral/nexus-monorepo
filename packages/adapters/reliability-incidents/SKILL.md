...
2. replay a bounded source-owned incident export through `incident.capture.batch` (`replay: true` is accepted and ignored since 0.1.2; the immutable store dedupes by identity)
