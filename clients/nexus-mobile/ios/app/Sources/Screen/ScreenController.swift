...
final class ScreenController {
    ...
    /// Callback invoked when an nexus:// deep link is tapped in the canvas
    ...
    func navigate(to urlString: String) {
        ...
        {
            // Never try to load loopback URLs from a remote runtime.
    ...
    func snapshotBase64(
        ...
        format: NexusCanvasSnapshotFormat,
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = NexusKitResources.bundle
...
/// Handles navigation policy to intercept nexus:// deep links from canvas
@MainActor
