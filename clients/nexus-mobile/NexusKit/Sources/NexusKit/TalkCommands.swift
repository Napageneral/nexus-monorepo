...
public enum NexusTalkCommand: String, Codable, Sendable {
...
public struct NexusTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct NexusTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
