...
public typealias NexusPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NexusPlatformImage = UIImage
#endif

public struct NexusChatUsageCost: Codable, Hashable, Sendable {
...
public struct NexusChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NexusChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NexusChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NexusChatMessageContent: Codable, Hashable, Sendable {
...
public struct NexusChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NexusChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NexusChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NexusChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NexusChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NexusChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NexusChatMessageContent].self, forKey: .content) {
...
public struct NexusChatHistoryPayload: Codable, Sendable {
...
public struct NexusSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NexusSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NexusSessionPreviewItem]
}

public struct NexusSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NexusSessionPreviewEntry]

    public init(ts: Int, previews: [NexusSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NexusChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NexusChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NexusAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NexusChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NexusRuntimeHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NexusPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NexusPlatformImage?
...
public struct NexusChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
