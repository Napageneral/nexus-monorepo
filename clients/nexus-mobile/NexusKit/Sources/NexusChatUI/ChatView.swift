...
@MainActor
public struct NexusChatView: View {
    public enum Style {
        case standard
        case onboarding
    }
    ...
    private var visibleMessages: [NexusChatMessage] {
        let base: [NexusChatMessage]
    ...
    private func mergeToolResults(in messages: [NexusChatMessage]) -> [NexusChatMessage] {
    ...
    private func isToolResultMessage(_ message: NexusChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: NexusChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: NexusChatMessage) -> String {
