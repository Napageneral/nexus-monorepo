...
**Status:** ARCHIVED — pipeline data bus superseded by `NEXUS_REQUEST_TARGET.md`
**Last Updated:** 2026-02-09
**Archived:** 2026-02-27 — The NexusRequest pipeline data bus and event type naming are now canonical in `NEXUS_REQUEST_TARGET.md`. The in-memory pub/sub bus described here (for UI streaming, file events, etc.) is a separate concern but references outdated event types.
