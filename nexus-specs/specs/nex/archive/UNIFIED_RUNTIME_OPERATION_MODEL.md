...
**Date:** 2026-02-25
**Archived:** 2026-02-27 — The 7-stage pipeline (`receiveOperation`, `operation.preExecute`, etc.) and `NexusEvent` envelope have been replaced by the 5-stage pipeline and `NexusRequest` bus in `NEXUS_REQUEST_TARGET.md`. Operation registry concepts remain relevant but canonical stage/status/routing semantics are now in TARGET.
