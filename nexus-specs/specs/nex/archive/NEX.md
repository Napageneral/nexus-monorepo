...
**Archived:** 2026-02-27 — Pipeline stages, NexusRequest bus, operation model, and routing semantics are now canonical in `NEXUS_REQUEST_TARGET.md`.
**Database layout:** See `../DATABASE_ARCHITECTURE.md` for canonical database inventory (7 databases)
...
│    │  work.db            ← Workspaces, tasks, artifacts                    │    │
│    │                                                                        │    │
...
// state/config.json
{
  ...
  "data": {
    ...
    // Creates: events.db, agents.db, identity.db, memory.db, embeddings.db, runtime.db, work.db
  },
  "adapters": [
...
│       ├── memory.ts           # Memory System queries (elements, sets)
