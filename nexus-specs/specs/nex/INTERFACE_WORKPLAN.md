...
| 8 | `IdentityEnrichment` | Cortex → Identity Ledger | ✅ Defined | Passive write-back |
...
| 3 | `IdentityLookup` | `UNIFIED_SYSTEM.md` + `iam/ACCESS_CONTROL_SYSTEM.md` |
| 4 | `ACLResult` | `UNIFIED_SYSTEM.md` + `iam/ACCESS_CONTROL_SYSTEM.md` |
...
| # | Interface | Issue |
|---|-----------|-------|
| 8 | `IdentityEnrichment` | Defined but Cortex spec not complete |
...
| (2) EventTrigger | `UNIFIED_SYSTEM.md` | — |
| (3) IdentityLookup | `UNIFIED_SYSTEM.md` | `iam/ACCESS_CONTROL_SYSTEM.md` |
| (4) ACLResult | `UNIFIED_SYSTEM.md` | `iam/ACCESS_CONTROL_SYSTEM.md`, `iam/POLICIES.md` |
...
| (7) LedgerWrite | `UNIFIED_SYSTEM.md` | — |
| (8) IdentityEnrichment | `UNIFIED_SYSTEM.md` | (Cortex spec TODO) |
