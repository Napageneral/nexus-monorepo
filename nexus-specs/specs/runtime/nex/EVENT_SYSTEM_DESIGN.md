...
| Cortex API | **dbPath + search()** | SQL is primary interface, search handles embeddings |
...
- **Cortex (historical):** `~/nexus/home/projects/cortex/` — Legacy project name, now split into Ledger (primary event storage) and Cortex (derived knowledge layer)
