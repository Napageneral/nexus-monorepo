> **Status:** ARCHIVED — writer role absorbed into bundled automation registry
> **Archived:** 2026-02-27
...
2. `link_element_entity(fact_id, entity_id)` for each entity
3. Co-occurrences updated automatically by `link_element_entity`
...
link_element_entity(fact_id, entity_id)
