...
- `src/cortex-memory-v2/embeddings.ts` — use new factory
- `src/agents/tools/cortex-memory-writer-tools.ts` — remove hardcoded dimension
- `src/cortex-memory-v2/consolidation.ts` — remove hardcoded dimension
...
**Steps:**
1. Create `src/cortex-memory-v2/recall/graph.ts` — MPFP implementation
...
- `src/cortex-memory-v2/recall.ts` — wire graph strategy into parallel execution
- `src/cortex-memory-v2/recall/strategies.ts` — may need new file or refactor
...
**Files touched:**
- `src/cortex-memory-v2/recall/temporal.ts` — new file, temporal parsing + retrieval
- `src/cortex-memory-v2/recall.ts` — wire temporal strategy
- `src/cortex-memory-v2/recall/strategies.ts` — temporal spreading helper
...
**Steps:**
1. Implement link expansion in `src/cortex-memory-v2/recall/link_expansion.ts`
2. Wire as the graph strategy for mid-budget queries
3. Feed results into RRF fusion

**Files touched:**
- `src/cortex-memory-v2/recall/link_expansion.ts` — new file
- `src/cortex-memory-v2/recall.ts` — wire link expansion for mid budget
...
**Files touched:**
- `src/cortex-memory-v2/recall.ts` (or `recall/strategies.ts`) — refactor semantic + keyword into combined query
...
- `src/agents/tools/cortex-memory-writer-tools.ts` — log resolutions
- `src/cortex-memory-v2/consolidation.ts` — log merge proposals
