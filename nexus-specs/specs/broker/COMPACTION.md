...
3. Allows full history traversal through Cortex
...
4. **Cross-compaction search:** How to efficiently search across compacted sessions in Cortex?
...
- `AGENTS_LEDGER_SCHEMA.md` — Full Cortex agents ledger schema
