...
**Related:** GRANTS.md, POLICIES.md, ACCESS_CONTROL_SYSTEM.md, POLICY_ARCHITECTURE_UNIFICATION.md, AUDIT.md, ../nex/ingress/CONTROL_PLANE.md
...
- Safe default policies:
  ...
  - unknown/known senders denied exec by default
