...
Replaces openclaw's file-based storage entirely. 7 databases: events.db, agents.db, identity.db, memory.db, embeddings.db, runtime.db, work.db. Build from ledger specs.
...
| `db/memory.ts` | `../memory/MEMORY_SYSTEM.md` | Elements, sets, jobs |
