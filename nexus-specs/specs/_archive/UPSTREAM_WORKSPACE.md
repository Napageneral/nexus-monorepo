...
├── cortex/                           # Daily memory files (user creates)
│   ├── YYYY-MM-DD.md
...
- **Every Session**: Read `SOUL.md`, `USER.md`, `cortex/YYYY-MM-DD.md`, and `MEMORY.md` (main session only)
- **Memory**: Daily notes in `cortex/`, long-term in `MEMORY.md`
...
3. Read `cortex/YYYY-MM-DD.md` (today + yesterday)
