...
1. secrets are still host-env managed rather than fully centralized in a
   ...
   documented
2. AWS-side compliance evidence posture should be checked and documented, not
   merely assumed
...
This means final account-evidence closure still requires human/operator
Artifact review and, if needed, agreement acceptance.
...
- final closure remains blocked on Artifact agreement review/acceptance
