...
- `FRONTDOOR_AWS_HOSTING_AND_SERVER_CLASS_MODEL.md`
...
Hosting provider policy, `standard` vs `compliant`, and frontdoor's AWS hosting
baseline are defined in `FRONTDOOR_AWS_HOSTING_AND_SERVER_CLASS_MODEL.md`.
