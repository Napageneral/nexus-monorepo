...
3. verify hosted install policy for server class and deployment class
4. record server package state as `installing`
5. deliver the release artifact to the runtime
6. call runtime operator install
7. persist active server package state as `installed`
...
- [Frontdoor Architecture](/Users/tyler/nexus/home/projects/nexus/frontdoor/docs/specs/FRONTDOOR_ARCHITECTURE.md)
- [Frontdoor Package Registry And Lifecycle](/Users/tyler/nexus/home/projects/nexus/frontdoor/docs/specs/FRONTDOOR_PACKAGE_REGISTRY_AND_LIFECYCLE.md)
