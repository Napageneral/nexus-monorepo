...
One frontdoor instance may manage multiple providers simultaneously. Provider
selection is an internal policy derived from `server_class`, not a user-facing
cloud-vendor choice.
