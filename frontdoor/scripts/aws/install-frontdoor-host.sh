...
FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON="${FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON:-}"
...
if [ -z "$FRONTDOOR_RUNTIME_TOKEN_SECRET" ] && [ -z "$FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON" ]; then
  echo "FRONTDOOR_RUNTIME_TOKEN_SECRET or FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON is required" >&2
  exit 1
fi
...
if [ -z "$FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON" ]; then
  FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON="{\"${FRONTDOOR_RUNTIME_TOKEN_ACTIVE_KID}\":\"${FRONTDOOR_RUNTIME_TOKEN_SECRET}\"}"
fi
...
FRONTDOOR_RUNTIME_TOKEN_ACTIVE_KID=${FRONTDOOR_RUNTIME_TOKEN_ACTIVE_KID}
FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON=${FRONTDOOR_RUNTIME_TOKEN_SECRETS_JSON}
