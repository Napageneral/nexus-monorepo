export type paths = {
    ...
    "/operations/slack.processing.start": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Best-effort Slack transport status start. Uses assistant thread status when available and falls back to a temporary processing reaction. */
        post: operations["slack.processing.start"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/operations/slack.processing.stop": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Best-effort Slack transport status clear. Clears native assistant status and removes the temporary processing reaction if present. */
        post: operations["slack.processing.stop"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
