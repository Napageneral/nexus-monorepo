...
export type ImessageSendRequest = OperationRequest<"imessage.send">;
export type ImessageSendResponse = OperationResponse<"imessage.send">;

export type RecordsBackfillStageRequest = OperationRequest<"records.backfill.stage">;
export type RecordsBackfillStageResponse = OperationResponse<"records.backfill.stage">;
...
export interface Client {
  ...
  "imessage": {
    "send": (request: ImessageSendRequest, options?: RequestOptions) => Promise<ImessageSendResponse>;
  };
  "records": {
    "backfill": {
      "stage": (request: RecordsBackfillStageRequest, options?: RequestOptions) => Promise<RecordsBackfillStageResponse>;
    };
  };
}

export function createEveAdapterClient(options: ClientOptions): Client {
  ...
  return {
    ...
    "imessage": {
      "send": async (request: ImessageSendRequest, options?: RequestOptions) => {
      const input = request as Record<string, unknown>;
      return http.request<ImessageSendResponse>({
        method: "POST",
        path: "/operations/imessage.send",
        query: undefined,
        body: {
    ...
    "records": {
      "backfill": {
        "stage": async (request: RecordsBackfillStageRequest, options?: RequestOptions) => {
      const input = request as Record<string, unknown>;
      return http.request<RecordsBackfillStageResponse>({
        method: "POST",
        path: "/operations/records.backfill.stage",
        query: undefined,
        body: {
        "connection_id": input["connection_id"],
        "payload": input["payload"],
