export type paths = {
    ...
    "/operations/imessage.send": {
        ...
        get?: never;
        put?: never;
        /** Send an outbound iMessage through the local Messages app. */
        post: operations["imessage.send"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/operations/records.backfill.stage": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Stage historical Eve backfill into canonical JSONL chunk files for Nex bulk import. */
        post: operations["records.backfill.stage"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
