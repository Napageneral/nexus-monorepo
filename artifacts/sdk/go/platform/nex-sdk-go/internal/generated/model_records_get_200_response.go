...
type RecordsGet200Response struct {
	Ok bool `json:"ok"`
	Payload *RecordsGetResultSchema `json:"payload,omitempty"`
	Meta map[string]interface{} `json:"meta,omitempty"`
}

type _RecordsGet200Response RecordsGet200Response

// NewRecordsGet200Response instantiates a new RecordsGet200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewRecordsGet200Response(ok bool) *RecordsGet200Response {
...
func (o *RecordsGet200Response) GetOk() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *RecordsGet200Response) GetOkOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Ok, true
...
func (o *RecordsGet200Response) SetOk(v bool) {
	o.Ok = v
}

// GetPayload returns the Payload field value if set, zero value otherwise.
func (o *RecordsGet200Response) GetPayload() RecordsGetResultSchema {
	if o == nil || IsNil(o.Payload) {
		var ret RecordsGetResultSchema
		return ret
	}
	return *o.Payload
}
...
// and a boolean to check if the value has been set.
func (o *RecordsGet200Response) GetPayloadOk() (*RecordsGetResultSchema, bool) {
	if o == nil || IsNil(o.Payload) {
		return nil, false
	}
...
func (o *RecordsGet200Response) HasPayload() bool {
	if o != nil && !IsNil(o.Payload) {
		return true
	}
...
// SetPayload gets a reference to the given RecordsGetResultSchema and assigns it to the Payload field.
func (o *RecordsGet200Response) SetPayload(v RecordsGetResultSchema) {
	o.Payload = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *RecordsGet200Response) GetMeta() map[string]interface{} {
	if o == nil {
...
func (o *RecordsGet200Response) GetMetaOk() (map[string]interface{}, bool) {
...
func (o *RecordsGet200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *RecordsGet200Response) SetMeta(v map[string]interface{}) {
	o.Meta = v
}
...
func (o *RecordsGet200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varRecordsGet200Response := _RecordsGet200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRecordsGet200Response)

	if err != nil {
		return err
	}

	*o = RecordsGet200Response(varRecordsGet200Response)
