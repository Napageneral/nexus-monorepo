...
// GroupsGet200Response struct for GroupsGet200Response
type GroupsGet200Response struct {
	Ok bool `json:"ok"`
	Payload *GroupGetResultSchema `json:"payload,omitempty"`
...
func NewGroupsGet200Response(ok bool) *GroupsGet200Response {
...
func (o *GroupsGet200Response) GetOk() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *GroupsGet200Response) GetOkOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Ok, true
...
func (o *GroupsGet200Response) SetOk(v bool) {
	o.Ok = v
}

// GetPayload returns the Payload field value if set, zero value otherwise.
func (o *GroupsGet200Response) GetPayload() GroupGetResultSchema {
	if o == nil || IsNil(o.Payload) {
		var ret GroupGetResultSchema
		return ret
	}
	return *o.Payload
}
...
// and a boolean to check if the value has been set.
func (o *GroupsGet200Response) GetPayloadOk() (*GroupGetResultSchema, bool) {
	if o == nil || IsNil(o.Payload) {
		return nil, false
	}
...
func (o *GroupsGet200Response) HasPayload() bool {
	if o != nil && !IsNil(o.Payload) {
		return true
	}
...
// SetPayload gets a reference to the given GroupGetResultSchema and assigns it to the Payload field.
func (o *GroupsGet200Response) SetPayload(v GroupGetResultSchema) {
	o.Payload = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GroupsGet200Response) GetMeta() map[string]interface{} {
	if o == nil {
...
func (o *GroupsGet200Response) GetMetaOk() (map[string]interface{}, bool) {
...
func (o *GroupsGet200Response) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *GroupsGet200Response) SetMeta(v map[string]interface{}) {
	o.Meta = v
}
